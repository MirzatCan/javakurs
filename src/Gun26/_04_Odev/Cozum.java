...
public class Cozum {
    ...
    public static void main(String[] args) {
        ...
        bilgi.hesap=new ElektrikHesabi();
        bilgi.hesap.tuketimEkle(50);
        bilgi.hesap.tuketimEkle(60);
        bilgi.hesap.tuketimEkle(70);
        bilgi.hesap.toplamTuketimYaz();

        bilgi.hesap.faturaYaz(bilgi.isim);
